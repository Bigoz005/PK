...
public class BattleStateMachine : MonoBehaviour {
    ...
    private StatsHandler statContainer;
  ...
  //public GameObject itemSelectButton;
	...
	void Start ()
    {
        ...
        Instance = gameObject.GetComponent(typeof(Player)) as Player;
	...
	//ustalanie kto kogo atakuje, czym i ogolnie takie serce mechanizmu
    ...
    void CreateAttackButtons()
    {
        ...
        AttackButton.GetComponent<Button>().onClick.AddListener(() => Input6()); //odwolanie do funkcji '=>'
        AttackButton.transform.SetParent(actionSpacer, false);
        atkBtns.Add(AttackButton);

        //jezeli wiecej niz 0 atakow, dodaje do listy inaczej przycisk nieaktywny
        if (HeroesToManage[0].GetComponent<HeroStateMachine>().heroBattle.attacks.Count > 0)
        {
            foreach (BaseAttack melleAtk in HeroesToManage[0].GetComponent<HeroStateMachine>().heroBattle.attacks)
            {
                GameObject AttackSelectButton = Instantiate(attackSelectButton) as GameObject;
                Text AttackSelectButtonText = AttackSelectButton.transform.Find("Text").gameObject.GetComponent<Text>();
        ...
        if (HeroesToManage[0].GetComponent<HeroStateMachine>().heroBattle.MagicAttacks.Count > 0)
        {
            foreach (BaseAttack magicAtk in HeroesToManage[0].GetComponent<HeroStateMachine>().heroBattle.MagicAttacks)
            {
        ...
        Text ItemSelectButtonText = ItemSelectButton.transform.Find("Text").gameObject.GetComponent<Text>();
        ...
        if (HeroesToManage[0].GetComponent<HeroStateMachine>().hero.ItemsInBag.Count > 0)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                Text ItemButtonText = ItemSelectionButton.transform.Find("Text").gameObject.GetComponent<Text>();
    ...
    */
    ...
    public void Input7(BaseAttack choosenAttack) 
    {
        HeroChoice.Attacker = HeroesToManage[0].name;
        HeroChoice.AttackersGameObject = HeroesToManage[0];
        HeroChoice.Type = "Hero";
