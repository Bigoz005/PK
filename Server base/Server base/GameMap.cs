...
class GameMap
{
    ...
    public GameMap()
    {
        ...
        this.positiveY = 35F;
        this.negativeY = -20F;
        this.pY = new MapSquare(-31F,6F,27F,65F,null);
        this.nY = new MapSquare(-31F,-20F,27F,65F,null);
        GenerateSquares();
    }

    private void GenerateSquares()
    {
        this.pY.nodes.Add(new MapSquare(-31F, 6f, 27f, 32f, this.pY));
        this.pY.nodes.Add(new MapSquare(1F, 6f, 27f, 32f, this.pY));
        this.nY.nodes.Add(new MapSquare(-31F, -20f, 27f, 32f, this.nY));
        this.nY.nodes.Add(new MapSquare(1F, -20f, 27f, 32f, this.nY));
        ////if(this.pY.nodes[0] == null)
        ////{
        ////    Console.WriteLine("lel");
        ////}
        ////Aktualnie trzeba dawac baseY o jeden tile w gore poniewaz pasuje to do kolizji w unity
        this.pY.nodes[0].AddObject("LeafyTree1", -30f, 30f, 1f, 1f);
        //this.pY.nodes[0].AddObject("River", -12f, 0f, 2f, 13f);
        this.pY.nodes[1].AddObject("Rock", 30f, 31f, 1f, 1f);
        //this.pY.nodes[1].AddObject("River", 2f, 0f, 2f, 12f);
        ////Conifer - drzewo iglaste xD
        this.nY.nodes[0].AddObject("Fence", -15f, -4f, 2f, 9f);  //to jest przykladowa kolizja na mapie dla sprawdzenia kolizji
                                                                 //reszta tych nodów tutaj jest wymagana ze wzgledu na strukture kodu
        //this.nY.nodes[0].AddObject("River", -12f, 0f, 2f, 13f);
        this.nY.nodes[1].AddObject("Conifer1", 23f, -19f, 1f, 1f);
